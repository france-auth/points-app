            ...
            <form name="sign-up" onSubmit={handleSubmit} className="xs:space-y-6 xr:space-y-5">
              ...
              <p className="xs:text-[13px] xr:text-sm">Email
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg  border focus:outline-none focus:ring-1 focus:ring-[#1f7882] focus:ring-opacity-100outline-0 focus:border-r-orange-100"
                />
              </p>
              ...
              <p className="xs:text-[13px] xr:text-sm">Password
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg  border focus:outline-none focus:ring-1 focus:ring-[#1f7882] focus:ring-opacity-100"
                />
              </p>
